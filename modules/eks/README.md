...
| <a name="input_public_subnet_1a"></a> [public\_subnet\_1a](#input\_public\_subnet\_1a) | subnet to create eks cluster in AZ 1a | `string` | n/a | yes |
| <a name="input_public_subnet_1b"></a> [public\_subnet\_1b](#input\_public\_subnet\_1b) | subnet to create eks cluster in AZ 1b | `string` | n/a | yes |
...
| <a name="output_oidc"></a> [oidc](#output\_oidc) | THIS OIDC PROVIDER IS USED TO CREATE IAM ROLES FOR SERVICE ACCOUNTS IN EKS |
